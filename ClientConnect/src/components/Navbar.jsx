      ...
      <nav className="w-full px-4 lg:px-8 py-3">
        <div className="flex items-center justify-between">
          ...
          <div ref={dropdownRef} className="hidden lg:flex items-center space-x-8">
            ...
            {/* User Management Dropdown (Admin/HOD only) */}
            {user && (user.role === 'admin' || user.role === 'hod') && (
              <div className="relative">
                <button
                ...
                >
                  ...
                  Administration
                  <svg className={`w-4 h-4 transition-transform duration-200 ${activeDropdown === 'admin' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
            ...
            <Link to="/profile" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 font-medium text-lg">
              Profile
            </Link>
